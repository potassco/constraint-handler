...
execution_run/1. execution_run/2.
optimize_precision/1. optimize_precision/2.
optimize_maximizeSum/2. optimize_maximizeSum/3. optimize_maximizeSum/4.
preference_holds/1. preference_holds/2. preference_holds/3.
preference_variableValue/2. preference_variableValue/3. preference_variableValue/4.
warning_forbid/1. warning_forbid/2.
warning_ignore/1. warning_ignore/2.
...
\_passed(defaultArgs,bool_evaluate/2).
\_passed(defaultArgs,ensure/2).
\_passed(defaultArgs,evaluate/3).
...
\_passed(defaultArgs,warning_forbid/2).
\_passed(defaultArgs,warning_ignore/2).
