...
PreferenceWarning = common.PPEnum(
    "PreferenceWarning", ["unsupported"]
)
...
StatementWarning = common.PPEnum(
    "StatementWarning", ["notImplemented","pythonError"]
)
...
TypeWarning = common.PPEnum(
    "TypeWarning", ["failed_operation"]
)
