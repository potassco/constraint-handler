...
STATEMENT_SCHEMAS = {
    UserInput.DECLARE: InputSchema(
        flat_fact=FlatFact.VARIABLE_DECLARE,
        layout=(LayoutToken.IDENTIFIER,),
        collision_state="declared"
    ),
    UserInput.SET_DECLARE: InputSchema(
        flat_fact=FlatFact.SET,
        layout=(LayoutToken.IDENTIFIER,),
        collision_state="set_declared"
    ),
    ...
    UserInput.ENSURE: InputSchema(
        flat_fact=FlatFact.ENSURE,
        layout=(LayoutToken.IDENTIFIER, LayoutToken.EXPRESSION)
    ),
    UserInput.BOOL_EVALUATE: InputSchema(
        flat_fact=FlatFact.BOOL_EVALUATE,
        layout=(LayoutToken.PASS, LayoutToken.EXPRESSION)
    ),
    UserInput.SET_BASE_DOMAIN: InputSchema(
        flat_fact=FlatFact.SET_BASE_DOMAIN,
        layout=(LayoutToken.IDENTIFIER, LayoutToken.EXPRESSION)
    ),
    UserInput.SET_ASSIGN: InputSchema(
        flat_fact=FlatFact.SET_ASSIGN,
        layout=(LayoutToken.IDENTIFIER, LayoutToken.EXPRESSION)
    ),
