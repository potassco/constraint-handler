...
The **constraint_handler** is a powerful **library** built on top of [Clingo](https://potassco.org/clingo/). It is used for solving discrete combinatorial decision or optimization problems where constraints and variables are defined through expressions.
