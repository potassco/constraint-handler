...
\alt `assign' `(' <variable> `,' <expression> `)'
...
<variable-atom> ::=
~\alt `variable_assign' `(' <variable> `,' <expression> `)'
\alt `variable_assign' `(' <variable> `,' <expression> `,' <label> `)'
\alt `variable_choice' `(' <variable> `,' <expression> `)'
\alt `variable_choice' `(' <variable> `,' <expression> `,' <label> `)'
\alt `variable_declare' `(' <variable> `,' <domain> `)'
\alt `variable_declare' `(' <variable> `,' <domain> `,' <label> `)'
\alt `variable_default' `(' <variable> `,' <expression> `)'
\alt ...
\alt `variable_default' `(' <variable> `,' <expression> `,' <expression> `,' <int> `,' <label> `)'
\alt `variable_define' `(' <variable> `,' <expression> `)'
\alt `variable_define' `(' <variable> `,' <expression> `,' <label> `)'
\alt `variable_domain' `(' <variable> `,' <expression> `)'
\alt `variable_domain' `(' <variable> `,' <expression> `,' <label> `)'

<multimap-atom> ::=
~\alt `multimap_assign' `(' <variable> `,' <expression> `,' <expression> `)'
\alt `multimap_assign' `(' <variable> `,' <expression> `,' <expression> `,' <label> `)'

<set-atom> ::=
~\alt `set_assign' `(' <variable> `,' <expression> `)'
\alt `set_assign' `(' <variable> `,' <expression> `,' <label> `)'
\alt `set_baseDomain' `(' <variable> `,' <expression> `)'
\alt `set_baseDomain' `(' <variable> `,' <expression> `,' <label> `)'

<execution-atom> ::=
~\alt `execution_declare' `(' <term> `,' <statement> `,' <variable-list> `,' <variable-list> `)'
\alt `execution_declare' `(' <term> `,' <statement> `,' <variable-list> `,' <variable-list> `,' <label> `)'
\alt `execution_run' `(' <term> `)'
\alt `execution_run' `(' <term> `,' <label> `)'

<optimize-atom> ::=
~\alt `optimize_maximizeSum' `(' <expression> `,' <term> `)'
\alt `optimize_maximizeSum' `(' <expression> `,' <term> `,' <expression> `)'
\alt `optimize_maximizeSum' `(' <expression> `,' <term> `,' <expression> `,' <label> `)'
...
\alt `preference_holds' `(' <expression> `,' <int> `,' <label> `)'
\alt `preference_variableValue' `(' <variable> `,' <expression> `)'
\alt `preference_variableValue' `(' <variable> `,' <expression> `,' <int> `)'
\alt `preference_variableValue' `(' <variable> `,' <expression> `,' <int> `,' <label> `)'
...
\alt `ensure' `(' <expression> `,' <label> `)'
\alt `bool_evaluate' `(' <expression> `)'
\alt `bool_evaluate' `(' <expression> `,' <label> `)'
\alt `evaluate' `(' <expression> `)'
\alt `evaluate' `(' <expression> `,' <label> `)'
\alt <variable-atom>
\alt <multimap-atom>
\alt <set-atom>
\alt <execution-atom>
...
<atom> ::=
~\alt `value' `(' <variable> `,' <val> `)'
\alt `evaluated' `(' <operator> `,' <expression-list>  `,' <val> `)'
\alt `set_value' `(' <variable> `,' <val> `)'
\alt `multimap_value' `(' <variable> `,' <val> `,' <val> `)'
