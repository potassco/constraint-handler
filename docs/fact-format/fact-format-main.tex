...
\newcommand{\atoms}{A}
\newcommand{\discourse}{D}
\newcommand{\evaluate}[2]{eval(#1,#2)}
\newcommand{\redto}[2]{#1 \mapsto #2}
\newcommand{\entails}{\vdash}
\newcommand{\True}{\textsf{true}}
\newcommand{\False}{\textsf{false}}
\newcommand{\restr}[1]{|_{#1}}
\newcommand{\modelPart}[1]{{#1}_{\atoms}}
\newcommand{\theoryPart}[1]{{#1}_{\variables}}
\newcommand{\brave}[1]{\mathbf{brave}_{#1}}
\newcommand{\cautious}[1]{\mathbf{cautious}_{#1}}
\newcommand{\supremum}[1]{\mathbf{sup}_{#1}}
\newcommand{\infimum}[1]{\mathbf{inf}_{#1}}
