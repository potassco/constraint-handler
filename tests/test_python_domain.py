...
@pytest.mark.parametrize(
    ...
    [
        ...
        (operators.LogicOperator.leqv, (build_domain(True, False, None), build_domain(True, False, expression.Bad.bad))),
        ...
        (operators.LogicOperator.lxor, (build_domain(True, False, None), build_domain(True, False, expression.Bad.bad))),
