...
base_tests = [
    ...
    "type/inference/non_deterministic_python_type_inference",
    "type/inference/python_extract_type_inference",
    "type/inference/python_inference_type_warnings",
    "type/inference/statement_python_type_inference",
    "type/inference/type_inference_unknown_vs_no_type",
    "type/inference/type_inference_unknown_vs_no_type_statement_python",
    "type/inference/type_inference_unknown_vs_no_type_statement_python_nondeterministic",
    "type/warning/python",
