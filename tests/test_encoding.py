...
base_tests = [
    ...
    "datatype/float/int_comparison",
    "datatype/float/int_division",
    "datatype/float/other_eq_neq",
    "datatype/float/other_order",
    "datatype/float/rounding",
    "datatype/int/add_mult",
    "datatype/int/abs",
    "datatype/int/comparison",
    "datatype/int/compound_eq",
    "datatype/int/division",
    "datatype/int/extrema",
    "datatype/int/minus",
    "datatype/int/other_eq_neq",
    "datatype/int/other_order",
    "datatype/int/power",
    "datatype/int/subtraction",
    "datatype/strings",
    "engine/request",
