...
- convenience case `optimize_maximizeSum/3` has the label removed and is now `optimize_maximizeSum/2`
- convenience case `preference_variableValue/3` has the label removed and is now `preference_variableValue/2` 
- convenience case `preference_holds/2` has the label removed and is now `preference_holds/1`
